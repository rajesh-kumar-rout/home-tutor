...
<div class="w-full md:w-2/3 mb-6 md:mb-0 mx-auto">
    <form action="#" method="POST" class="bg-white p-8 rounded-lg shadow-lg">
        <h2 class="mb-6 text-xl font-bold text-center">Create New Question</h2>
        <div class="mb-4">
            <label for="name" class="block text-gray-700 font-bold mb-2">Question</label>
            <input type="text" id="name" name="name"
                class="w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required="">
        </div>

        <div class="mb-4">
            <label for="email" class="block text-gray-700 font-bold mb-2">Answer</label>
